...
print('test -- arithmetics-bignums');
var big = 2147483646;
...
assert ((1152921504606846976).toString() === "1152921504606846976");
...
assert((1.00517e+21).toString() === "1.005170e+21");

assert((1.00001e+21).toString() === "1.000010e+21");
