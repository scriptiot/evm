...
void heatshrink_ptr_output_cb(unsigned char ch, uint32_t *cbdata, uint32_t * count); // takes **data
int heatshrink_ptr_input_cb(uint32_t *cbdata, uint32_t * count); // takes *HeatShrinkPtrInputCallbackInfo
void heatshrink_var_output_cb(unsigned char ch, uint32_t *cbdata, uint32_t * count); // takes *JsvStringIterator
int heatshrink_var_input_cb(uint32_t *cbdata, uint32_t * count); // takes *JsvIterator
